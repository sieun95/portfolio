...
const projects: Project[] = [
  {
    ...
    title: 'Dear My AI',
    desc: 'Claude API 기반 AI 편지 서비스. AI를 페르소나로 만들어 그리운 사람과 편지를 주고받을 수 있으며, 사용자가 설정한 페르소나를 기반으로 AI가 감성적인 답장을 생성합니다.',
  ...
  },
  {
    ...
    title: 'AI B2B 쇼핑몰',
    desc: 'Gemini AI 기반 B2B 커머스 플랫폼. AI 챗봇 상담, 맞춤 상품 추천, 수요 예측(선형 회귀 + 가중 이동평균), 트렌드 분석, 재주문/재입고 추천 등 AI가 데이터를 해석하고 자연어로 인사이트를 제공합니다. 프론트엔드와 백엔드를 1인 풀스택으로 설계·구현했습니다.',
